# Generated by Django 5.2 on 2025-04-12 12:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(blank=True, default='default.jpg', null=True, upload_to='user_images')),
                ('gender', models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('other', 'Other')], default='other', max_length=10)),
                ('social_accounts', models.JSONField(blank=True, default=dict, null=True)),
